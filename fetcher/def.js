function generateMatchupDataForDefenders() {
    ...
    Logger.log("Starting data generation for defenders...");
    ...
    for (let i = 1; i < sourceData.length; i++) { // Start from row 2 to skip the header
      ...
      // Only process if the position is "def" (defender), case-insensitive
      if (pos.toLowerCase() === "def") {
        ...
        otherTeams.forEach(opponent => {
          ...
          rowsToInsert.push([
            ...
            generateHash(playerName + teamName), // Column E: DEF ID (hash of player name + team name)
    ...
    Logger.log("Matchup data for defenders generated and inserted successfully.");
  }

...
// Function to insert data into the FPL_HUB_DEF_Data table
function insertFPLHubDEFData($pdo, $data) {
    echo "Attempting to insert data into database...\n"; // Debugging
    $query = "INSERT INTO fpl_hub_def_data (player_name, player_id, team_id, web_name, def_id, opp_team, ground, team_score, opp_score, result, points, saves, minutes, goals, assists, xg, xa, xgi, cs, goals_conceded, xgc, own_goals, penalties_saved, penalties_missed, yellow_cards, red_cards, shots, bonus, bps, influence, creativity, threat, ict_index, transfers_balance, selected, pyfy)
              VALUES (:player_name, :player_id, :team_id, :web_name, :def_id, :opp_team, :ground, :team_score, :opp_score, :result, :points, :saves, :minutes, :goals, :assists, :xg, :xa, :xgi, :cs, :goals_conceded, :xgc, :own_goals, :penalties_saved, :penalties_missed, :yellow_cards, :red_cards, :shots, :bonus, :bps, :influence, :creativity, :threat, :ict_index, :transfers_balance, :selected, :pyfy)";
    ...
    try {
        ...
        echo "Data successfully inserted into FPL_HUB_DEF_Data table.\n";
    } catch (PDOException $e) {
...
$spreadsheetId = '1B9-BeWghrRkZnWeKdaqZPf2gZVb8qAWdb69AOFoW9ds';
$range = '24/25!A2:AJ';

// Clear existing values from the database table
clearDatabaseTable($pdo, 'fpl_hub_def_data');
...
insertFPLHubDEFData($pdo, $formattedData);
?>
...
// Function to insert data into the FPL_HUB_GKP_Data table
function insertFPLHubGKPData($pdo, $data) {
    echo "Attempting to insert data into database...\n"; // Debugging
    $query = "INSERT INTO fpl_hub_gkp_data (player_name, player_id, team_id, web_name, gkp_id, opp_team, ground, team_score, opp_score, result, points, saves, minutess, goals, assists, xg, xa, xgi, cs, goals_conceded, xgc, own_goals, penalties_saved, penalties_missed, yellow_cards, red_cards, shots, bonus, bps, influence, creativity, threat, ict_index, transfers_balance, selected, pyfy)
              VALUES (:player_name, :player_id, :team_id, :web_name, :gkp_id, :opp_team, :ground, :team_score, :opp_score, :result, :points, :saves, :minutess, :goals, :assists, :xg, :xa, :xgi, :cs, :goals_conceded, :xgc, :own_goals, :penalties_saved, :penalties_missed, :yellow_cards, :red_cards, :shots, :bonus, :bps, :influence, :creativity, :threat, :ict_index, :transfers_balance, :selected, :pyfy)";
    ...
    try {
        ...
        echo "Data successfully inserted into FPL_HUB_GKP_Data table.\n";
    } catch (PDOException $e) {
...
$spreadsheetId = '1OVSPPq_JSfv1TnoLhmb3X4Y3UdB0aVtqngCsVQzJvaY';
$range = '24/25!A2:AJ';

// Clear existing values from the database table
clearDatabaseTable($pdo, 'fpl_hub_gkp_data');
...
insertFPLHubGKPData($pdo, $formattedData);
?>
